 ...
 * @property string $Country         The customer’s shipping country. This should be the two letter ISO 3166-1 alpha-2 code. This field must be lower
 *           case. e.g. Australia = au
 * @property string $Email           The customer’s shipping email address, which must be correctly formatted if present.
